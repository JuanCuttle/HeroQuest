...
public enum Strings {
	...
	CANT_OPEN_DOOR {
	  ...
	  DISCONNECTION_ATTEMPT_BEFORE_BEING_CONNECTED {
	      public String toString() {
	    	  switch(GUI.language) {
	  ...
	  START_ATTEMPT_BEFORE_CONNECTING {
	      public String toString() {
	    	  switch(GUI.language) {
	...
	SELECT_DOOR {
	  ...
	  DISARMED_TREASURE_TRAP {
		  public String toString() {
	    	  switch(GUI.language) {
				  case Portugues:
					  return "O heroi desarmou uma armadilha em um tesouro!";
				  default:
	  ...
	  THRONE_PASSAGE_REVEALED {
		  public String toString() {
			  switch(GUI.language) {
				  case Portugues: return "O trono se moveu para revelar uma passagem secreta!";
				  default: return "The throne moved to reveal a hidden passage!";
	    	  }
	      }
	  },
	  ...
	  INSTRUCTION_MANUAL {
	      public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "Manual de Instru��es";
				  default: return "Instruction Manual";
	    	  }
	      }
	  },
	  ...
	  CONFIRM_LOAD_FILE {
	      public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "Um arquivo com o seu nome j� existe, deseja carreg�-lo?";
				  default: return "A file with your name already exists, do you wish to load it?";
	    	  }
	      }
	  },

	THE_TRIAL_DESCRIPTION {
	      public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "Voc�s aprenderam bem, meus amigos. Agora chegou a hora do seu primeiro desafio."
				  ...
				  default: return "You have learned well, my friends. Now has come the time of your first trial."
	  ...
	  THE_RESCUE_OF_SIR_RAGNAR_DESCRIPTION {
		  public String toString() {
			  switch (GUI.language) {
				  case Portugues: return "Sir Ragnar, um dos mais poderosos guerreiros do Imperados, foi raptado. "
				  ...
				  default: return "Sir Ragnar, one of the Emperor's most powerful Knights, has been kidnapped. "
	  ...
	  THE_MAZE_DESCRIPTION {
		  public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "Este ser� seu �ltimo teste antes de seguir adiante. \nAtente para usar as "
				  ...
				  default: return "This will be your final test before you set forth. \nBe sure to use the skills "
	  ...
	  LAIR_OF_THE_ORC_WARLORD_DESCRIPTION {
		  public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "O Pr�ncipe Magnus ordenou que o General dos Orcs, Ulag, que foi respons�vel "
				  ...
				  default: return "Prince Magnus has ordered that the Orc Warlord Ulag, who was responsible for "
	  ...
	  PRINCE_MAGNUS_GOLD_DESCRIPTION {
		  public String toString() {
	    	 switch (GUI.language) {
				 case Portugues: return "Tr�s ba�s de tesouro foram roubados enquanto eram levados ao Imperador."
				 ...
				 default: return "Three treasure chests have been stolen whilst being taken to the Emperor."
	  ...
	  MELARS_MAZE_DESCRIPTION {
		  public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "H� muito tempo, um poderoso feiticeiro chamado Melar criou um Talism� o qual "
				  ...
				  default: return "Long ago, a powerful sorcerer by the name of Melar created a Talisman which "
	  ...
	  LEGACY_OF_THE_ORC_WARLORD_DESCRIPTION {
		  public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "O horrendo filho de Ulag, Grak, jurou vingan�a contra aqueles que mataram seu pai."
				  ...
				  default: return "Ulag's foul offspring, Grak, has sworn revenge on those who killed his father."
	  ...
	  THE_STONE_HUNTER_DESCRIPTION {
		  public String toString() {
	    	  switch (GUI.language) {
				  case Portugues: return "O Mago pessoal do Imperador, Karlen, desapareceu. O Imperador teme que ou ele "
				  ...
				  default: return "The Emperor's personal Wizard, Karlen has disappeared. The Emperor fears that "
	  ...
	  FOUND_KARLEN {
		  public String toString() {
			  switch (GUI.language) {
				  case Portugues: return "O Zumbi nesta sala � Karlne. Enquanto trabalhava em uma magia de Chaos ele foi consumido "
	    		  		+ "\npela magia que ele criou e foi transformado em um Zumbi lobotomizado.";
				  default: return "The Zombie in this room is Karlen. Whilst working on a Chaos spell he was consumed "
	    		  		+ "\nby the magic he created and was turned into a mindless Zombie.";
	    	  }
	      }		
	  },
	  
	  THE_FIRE_MAGE_DESCRIPTION {
		  public String toString() {
			  switch (GUI.language) {
				  case Portugues: return "Os Orcs das Montanhas Negras t�m usado magias de Fogo em seus ataques. Balur, "
				  ...
				  default: return "The Orcs of the Black Mountains have been using Fire magic in their raids. Balur, "
